...
const PriceRange: React.FC = () => {
   ...
   const { minPrice, maxPrice, selectedPrice } = useAppSelector((state) => state.filter.filterData)
      ...
      <InputContainer>
         <FormControl fullWidth>
            <FormLabel color='primary'>
               Ár: (
               <NumberFormat value={selectedPrice[0]} thousandSeparator=' ' suffix=' Ft' displayType='text' />
               - <NumberFormat value={selectedPrice[1]} thousandSeparator=' ' suffix=' Ft' displayType='text' />)
            </FormLabel>
            <Slider
